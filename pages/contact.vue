  ...
  <div class="container mx-auto my-10 flex justify-between">
    <div class="max-w-[300px]">
      ...
      <p class="font-semibold text-lg my-2">
        https://instagram.com/saxovatmarket/
      </p>
    ...
    <div>
      <div class="max-w-[300px]">
        ...
        <p class="text-lg font-semibold my-1">MFO: 00459</p>
        <p class="text-lg font-semibold my-1">O‘zbekiston, Toshkent viloyati, Piskent tumani, Hamid olimjon k. №1</p>
        <p class="text-lg font-semibold my-1">Ipoteka bank, Olmaliq filiali</p>
        <p class="text-lg font-semibold my-1">OKONX: 01470</p>
      </div>
    </div>
    <div>
      <div class="max-w-[300px]">
